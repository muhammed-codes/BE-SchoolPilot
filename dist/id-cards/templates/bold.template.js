...
exports.boldTemplate = void 0;
const enums_1 = require("../../common/enums");
const getAccentColor = (data) => {
    if ('admissionNumber' in data)
        return '#1A56A8';
    const role = data.role;
    const colorMap = {
        [enums_1.UserRole.PRINCIPAL]: '#7C3AED',
        [enums_1.UserRole.CLASS_TEACHER]: '#059669',
        [enums_1.UserRole.SUBJECT_TEACHER]: '#0891B2',
        [enums_1.UserRole.SCHOOL_ADMIN]: '#1A56A8',
    };
...
exports.boldTemplate = boldTemplate;
//# sourceMappingURL=bold.template.js.map