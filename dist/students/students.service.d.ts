...
export declare class StudentsService {
    ...
    constructor(studentsRepository: Repository<Student>, studentParentsRepository: Repository<StudentParent>, usersService: UsersService, uploadService: UploadService, dataSource: DataSource, classesService: ClassesService);
